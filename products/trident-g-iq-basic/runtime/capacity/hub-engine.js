...
export function displayHubTargetLabel(targetModality, wrapper) {
  if (wrapper === "and_cat" || wrapper === "and_noncat") {
    const objectLabel = wrapper === "and_cat" ? "ANIMAL" : "SHAPE";
    if (targetModality === "loc_sym") return `LOCATION + ${objectLabel}`;
    if (targetModality === "loc_col") return "LOCATION + COLOUR";
    return `${objectLabel} + COLOUR`;
  }
